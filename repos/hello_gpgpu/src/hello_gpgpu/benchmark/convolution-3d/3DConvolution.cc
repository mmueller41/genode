...
namespace ns_convolution_3d {

#include "3DConvolution_kernel.h"
...
void cl_load_prog()
{
	...
	const size_t kernel_size = __3DConvolution_Gen9core_gen_len;
    const unsigned char* kernel_bin = __3DConvolution_Gen9core_gen;
