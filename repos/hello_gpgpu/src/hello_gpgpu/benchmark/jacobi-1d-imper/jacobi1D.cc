...
namespace ns_jacobi_1d_imper 
{


#include "../../polybenchUtilFuncts.h"
#include "jacobi1D_kernel.h"
...
void cl_load_prog()
{
	...
	const size_t kernel_size = jacobi1D_Gen9core_gen_len;
    const unsigned char* kernel_bin = jacobi1D_Gen9core_gen;
