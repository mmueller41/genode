...
#include <tukija_native_pd/tukija_native_pd.h>
#include <base/rpc_client.h>

namespace Genode { struct Tukija_native_pd_client; }


struct Genode::Tukija_native_pd_client : Rpc_client<Pd_session::Native_pd>
{
	explicit Tukija_native_pd_client(Capability<Native_pd> cap)
