include $(call select_from_repositories,mk/spec/tukija.mk)

TARGET           = hypervisor
REQUIRES         = x86 tukija
NOVA_BUILD_DIR   = $(BUILD_BASE_DIR)/kernel
NOVA_SRC_DIR    := $(call select_from_ports,tukija)/src/kernel/tukija
...
hypervisor.o: $(NOVA_SRC_DIR)/src/hypervisor.ld target.mk
	$(VERBOSE)$(CC) $(INCLUDES) -DCONFIG_MEMORY_BOOT=8M -MP -MMD -pipe $(CC_MARCH) -xc -E -P $< -o $@
