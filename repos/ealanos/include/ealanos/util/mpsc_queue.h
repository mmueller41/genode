...
#ifndef __EALANOS__INCLUDE__UTIL__MPSC_QUEUE_H_
#define __EALANOS__INCLUDE__UTIL__MPSC_QUEUE_H_
...
private:
    ...
    alignas(64) char _stub[sizeof(T)];
};
...
#endif /* __EALANOS__INCLUDE__UTIL__MPSC_QUEUE_H_ */